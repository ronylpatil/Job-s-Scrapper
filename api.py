...
def predict_model(parameters : Input) :
    ...
    driver.find_elements_by_xpath('//*[@id="root"]/div[4]/div[1]/div/section[2]/div[1]/div[2]/span/span[2]/p/i')[0].click()
    driver.find_element_by_xpath('//*[@id="root"]/div[4]/div[1]/div/section[2]/div[1]/div[2]/span/span[2]/ul/li[2]').click()
    t.sleep(4)
